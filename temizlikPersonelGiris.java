...
public class temizlikPersonelGiris extends javax.swing.JFrame {
    ...
    private void initComponents() {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(uyarilbl, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(uyarilbl, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(girisbutton)
                .addGap(14, 14, 14))
        );
    ...
    private void girisbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_girisbuttonActionPerformed
        ...
        if (Integer.valueOf(tctxt.getText()) == tp1 && Integer.valueOf(sifretxt.getText()) == sifre1) {
             temizlik_personeli_giris p = new temizlik_personeli_giris();
        p.setVisible(true);
        } else if (Integer.valueOf(tctxt.getText()) == tp2 && Integer.valueOf(sifretxt.getText()) == sifre2) {
            temizlik_personeli_giris p = new temizlik_personeli_giris();
        p.setVisible(true);
        } else if (Integer.valueOf(tctxt.getText()) == tp3 && Integer.valueOf(sifretxt.getText()) == sifre3) {
           temizlik_personeli_giris p = new temizlik_personeli_giris();
        p.setVisible(true);
        } else {
